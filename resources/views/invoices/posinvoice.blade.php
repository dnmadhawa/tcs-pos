            ...
            <tr>
                <div class="mt-4">
                    <div class="row text-600 text-white bgc-default-tp1 py-25">
                        <th><div class="d-none d-sm-block col-1">#</div></th>
                        <th><div class="col-9 col-sm-3">Description</div></th>
                        <th><div class="d-none d-sm-block col-4 col-sm-2">Qty</div></th>
                        <th><div class="d-none d-sm-block col-4 col-sm-2">Discount</div></th>
                        <th><div class="d-none d-sm-block col-sm-2">Unit Price</div></th>
                        <th><div class="col-2">Amount</div></th>
                    </div>
            </tr>
            <tr>
                <td>1</td>
