<template>
    <tbody>
        <tr v-for="(item,index) in items" v-bind:key="item.id">
            ...
            <td><input type="number" class="form-control" :value="item.discount" v-on:keyup="calDiscountPrice(index,$event.target.value)" @change="calDiscountPrice(index,$event.target.value)"></td>
